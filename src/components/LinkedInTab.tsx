...
export function LinkedInTab({ rows, prevRows = [], loading, error }: LinkedInTabProps) {
  ...
  const postsTrend = getTrend(rows.length, prevRows.length);
